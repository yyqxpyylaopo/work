...
let musicList=[{
	...
	url:'/music/ComeThrough.mp3',
	img:'./images/ComeThrough.jpg',
},{
	id:"1892632507",
	name:'wyd?',
	...
	url:'./music/California.MP3',
	img:'./images/California.jpg',
},{
	id:"1921892053",
	name:'EverySummertime-NIKI ',
	singer:'i8-NPCのABC',
	url:'./music/EverySummertime.MP3',
	img:'./images/EverySummertime.jpg',
},{
	id:"1877751193",
	name:'Ride',
	singer:'HYBS-Ride',
...
function renderMinMusic(){
	...
	if(localStorage.getItem(nowMusic.id)){
		$(".musicMinLikeBtn").attr('src','./images/Like.png')
		$(".musicBtn img").attr('src','./images/Like.png')
	}else{
		$(".musicMinLikeBtn").attr('src','./images/noLike.png')
		$(".musicStartBox .musicBtn img").attr('src','./images/noLike.png')
	}
...
function playMusic(){
	...
	$("#music")[0].play();
	$(".pauseBig").attr('src','./images/pauseBig.png');
...
function musicTimeInterval(){
	...
	$(".musicMinNowprogress").css('width',percentage)
	timer = setInterval(()=>{
		time++;
		if(time>=duration){
			switch (playType){
